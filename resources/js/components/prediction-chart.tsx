...
const PredictionChart = ({
                ...
                const predictionChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            {
                                label: 'RekomendasiCottoni Basah',
                            ...
                            {
                                label: 'RekomendasiCottoni Kering',
                            ...
                            {
                                label: 'RekomendasiSpinosum Basah',
                            ...
                            {
                                label: 'RekomendasiSpinosum Kering',
    ...
    return (
        <div className="flex h-max w-full flex-col items-center">
            <h3>Hasil RekomendasiProduktivitas Rumput Laut</h3>
