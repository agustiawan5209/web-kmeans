...
const InformationModelStep = () => {
    ...
    return (
        <motion.div initial="hidden" animate="visible" variants={fadeIn} className="mx-auto h-screen max-w-7xl rounded-lg bg-white p-6 shadow-md overflow-y-auto">
            <h1 className="mb-6 text-3xl font-bold text-green-700">Sistem Prediksi Makanan Pertanian</h1>
            ...
            {activeTab === 'training' ? (
                ...
                <motion.div variants={fadeIn}>
                    <h2 className="mb-4 text-2xl font-semibold text-green-600">Tata Cara Prediksi Dataset</h2>
