    ...
    return (
        ...
        >
            ...
            <p className="mb-6 text-gray-600">
                ...
                <span className="font-semibold"> Regresi Linear Berganda</span> untuk prediksi hasil dataset,
                <span className="font-semibold"> Kluster K-Means</span> untuk pemilihan indikator, dan
                <span className="font-semibold"> K-means</span> untuk menemukan pola asosiasi antara faktor-faktor produksi.
            </p>

            <div className="mb-6 flex border-b">
                <button
                    className={`px-4 py-2 font-medium ${activeTab === 'training' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500'}`}
            ...
            {activeTab === 'training' ? (
                <motion.div variants={fadeIn}>
                    <h2 className="mb-4 text-2xl font-semibold text-blue-600">Tata Cara Pelatihan Model</h2>
                    ...
                    <div className="space-y-6">
                        <StepCard
                            ...
                            content={
                                <div className="space-y-2">
                                    <p>
                                        Masuk Ke Halaman Pola Asosiasi Lalu pilih Threshold dan Support untuk menampilkan hasil aturan pola asosiasi
                                    </p>
                                </div>
                            }
                        />
                        <StepCard
                            ...
                            content={
                                <div className="space-y-2">
                                    <p>algoritma K-Means digunakan untuk mengelompokkan hasil dataset sesuai dengan klusternya masing-masing</p>
                                    <p>dengan menggunakan centroid dari interpresentasi dari data dataset</p>
                                </div>
                            }
                        />
                        ...
                        <StepCard
                            step={3}
                            title="Pola Asosiasi dengan K-means"
                            content={
                                <div className="space-y-2">
                                    <p>menampilkan hubungan antara indikator dengan aturan hasil dari K-means</p>
                                </div>
                            }
                        />
                        ...
                        <StepCard
                            ...
                            content={
                                <div className="space-y-2">
                                    <p>Buat model prediksi hasil dataset:</p>
                                    <ul className="list-disc space-y-1 pl-5">
                                        <li>Pilih variabel independen berdasarkan hasil K-Means dan K-means</li>
                            ...
                            content={
                                <div className="space-y-2">
                                    ...
                                    <ul className="list-disc space-y-1 pl-5">
                                        ...
                                        <li>Dapatkan prediksi hasil dataset</li>
            ...
            <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
                <h3 className="mb-2 font-semibold text-blue-700">Catatan Penting:</h3>
